        ...
        <div className="content-wrap">
          ...
          <section className="analysis-grid">
            <div className="map-column">
              ...
              {activeTab === "overview" ? <ForestMap layers={layers} /> : <div className="quality-panel"><div className="quality-hero"><div><span className="eyebrow">DATA CONFIDENCE</span><h2>Strong enough for a pilot review</h2><p>Evidence coverage is high for vegetation analysis. Tree-level and biomass outputs remain provisional.</p></div><div className="quality-score">97<span>%</span><small>valid pixels</small></div></div><div className="quality-list"><div><span>Optical coverage</span><b>97.05%</b><i><span style={{ width: "97%" }} /></i></div><div><span>Scene cloud cover</span><b>0.26%</b><i><span style={{ width: "9%", background: "#f0bc70" }} /></i></div><div><span>Crown confidence</span><b>82%</b><i><span style={{ width: "82%", background: "#bc88e7" }} /></i></div><div><span>Change confidence</span><b>76%</b><i><span style={{ width: "76%", background: "#e38c67" }} /></i></div></div><div className="warning-box"><AlertTriangle size={17} /><span>Satellite resolution is 10 m. Crown boundaries are a prototype demonstration, not field-validated tree enumeration.</span></div></div>}
